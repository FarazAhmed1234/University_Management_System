...
const Register = ({ userName, onLogout }) => {
  ...
  const fetchStudentData = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:8080/educonnect-backend/get_student.php?student_id=${studentId}`
      );
  ...
  const fetchSemesterCourses = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:8080/educonnect-backend/get_semester.php?student_id=${studentId}&semester=${semester}`
      );
      const data = await response.json();
  ...
  const fetchRegisteredCourses = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:8080/educonnect-backend/get_registered_courses.php?student_id=${studentId}&semester=${semester}`
      );
      const data = await response.json();
  ...
  const registerCourse = async (course) => {
    ...
    try {
      const response = await fetch(
        'http://localhost:8080/educonnect-backend/register_course.php',
        {
          method: 'POST',
          headers: {
